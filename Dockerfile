...
RUN cd /tmp && wget --no-check-certificate https://github.com/crypto-org-chain/cronos/releases/download/v0.7.0-rc2/cronos_0.7.0-rc2-testnet_Linux_x86_64.tar.gz && tar -xvf cronos_0.7.0-rc2-testnet_Linux_x86_64.tar.gz \
